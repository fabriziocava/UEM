...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
	<div class="container-up">
		<ul class="dashboard">
			<li><a class="button" href="#" id="ordinamentiButton" title="<spring:message code='label.gestioneOrdinamenti.description'/>"
			...
			<li><a class="button" href="#" id="assignButton" title="<spring:message code='label.assignCourse.description'/>"
				onclick="selectDashBoard(this)"><spring:message
